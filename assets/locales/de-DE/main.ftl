...
modal-how-dedup-step6-desc = Für die verbleibenden Kandidaten wird ein vollständiger BLAKE3-Hash berechnet. Wegen der extrem großen Kollisionsresistenz dieses 256 Bit Hashes, bedeuten identische Hashes mit sehr hoher Wahrscheinlichkeit identische Inhalte, was paarweise Binärvergleiche erübrigt.
